...
import HomeMainNav from "../components/layout/HomeMainNav";
import IllustrationEmpty from "../assets/suggestions/illustration-empty.svg";
import SuggestionCard from "../components/SuggestionCard";
import TabFilter from "../components/layout/TabFilter";
...
function Suggestions() {
  ...
  const updateSuggestionsHandler = (activeTab) => {
    ...
    activeTab === "all"
      ...
      : setSuggestions(
          originalSuggestionData.filter(
            (suggestion) => suggestion.category === activeTab
          )
        );
        ...
        <div className="home-container">
          <section className="home-left">
            <div className="home-left-intro">
              <div>
                <h2 className="text-white font-bold text-2xl">Opinia</h2>
                <p className="body-s home-left-intro-subtitle">
                  Feedback board
                </p>
              </div>
            ...
            <main>
              {suggestions.length > 0 ? (
                ...
                <div className="home-no-feedback">
                  ...
                  />
                  <h1 className="home-no-feedback-title">
